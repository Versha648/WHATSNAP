...
def handle_client(c, addr):
    ...
    rst_img = PhotoImage(file="google.png")
    ggt.config(image=rst_img)
    hst = Button(top, text="filters", font=30, width="18", height=3, bd=0, command=(lambda: filters()))
    tit_img = PhotoImage(file="glass.png")
    hst.config(image=tit_img)
    ...
    hst.place(x=240, y=3, height=32, width=32)
